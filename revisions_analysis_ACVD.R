...
saveRDS(list(voe_df_3var_mdat1_nonlogged),'nonlogged_3var_voe_ACVD.rds')
...
saveRDS(list(voe_df_6var_mdat1_nonlogged),'nonlogged_6var_voe_ACVD.rds')
...
saveRDS(list(voe_df_9var_mdat1_nonlogged),'nonlogged_9var_voe_ACVD.rds')
...
saveRDS(list(voe_df_3var_mdat1_clr),'clr_3var_voe_ACVD.rds')
...
saveRDS(list(voe_df_6var_mdat1_clr),'clr_6var_voe_ACVD.rds')
...
saveRDS(list(voe_df_9var_mdat1_clr),'clr_9var_voe_ACVD.rds')
